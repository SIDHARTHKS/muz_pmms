...
class AppBaseConnect extends GetConnect {
  ...
  /// Constructor for [AppBaseConnect].
  ///
  ...
  /// Initializes the [AppBaseConnect] instance by setting the base URL, headers, and authenticator.
  @override
  void onInit() {
